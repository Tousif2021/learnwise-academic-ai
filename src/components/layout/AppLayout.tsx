        ...
        <Sidebar className="border-r border-border">
          ...
          <SidebarContent className="px-2">
            <div className="space-y-1 py-2">
              <SidebarLink to="/" icon={<Monitor size={18} />} label="Dashboard" />
              <SidebarLink to="/courses" icon={<Book size={18} />} label="Courses" />
              <SidebarLink to="/calendar" icon={<Calendar size={18} />} label="Calendar" />
              <SidebarLink to="/profile" icon={<UserIcon size={18} />} label="Profile" />
        ...
        <main className="flex-1 flex flex-col">
          <header className="h-14 border-b border-border flex items-center px-4 md:px-6 justify-between">
            ...
            <div className="flex items-center gap-2">
              <button className="bg-edu-secondary/10 text-edu-secondary hover:bg-edu-secondary/20 rounded-full p-1.5 transition-colors">
                <Settings size={18} />
              </button>
            </div>
          </header>
